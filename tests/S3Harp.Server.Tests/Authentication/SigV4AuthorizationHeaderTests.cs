...
public sealed class SigV4AuthorizationHeaderTests
{
    ...
    public void TryParse_ReadsAllComponentsOfAValidHeader()
    {
        ...
        Assert.Equal("f0e8bdb87c964420e857bd35b5d6ed310bd44f0170aba48dd91039c6036bdb41", header.Signature);
    }
    ...
    [InlineData("AWS4-HMAC-SHA256 Credential=akid/20130524/us-east-1/s3, SignedHeaders=host, Signature=abc")]
    [InlineData("AWS4-HMAC-SHA256 Credential=akid/20130524/us-east-1/s3/other, SignedHeaders=host, Signature=abc")]
    [InlineData("AWS4-HMAC-SHA256 Credential=akid/20130524/us-east-1/s3/aws4_request, Unknown=x, SignedHeaders=host, Signature=abc")]
