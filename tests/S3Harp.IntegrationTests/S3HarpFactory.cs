...
/// <summary>
/// Hosts S3Harp on real Kestrel with test credentials and hands out AWS SDK clients.
/// The AWS SDK is the compatibility oracle, so tests exercise real HTTP end to end.
/// </summary>
